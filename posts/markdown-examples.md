...
::: tip
标题带有 %verified% 图标代表本主题已适配此功能。
:::

## 标题锚点 %verified% {#header-anchors}
...
还可以在全局配置中自定义语法高亮主题、配置语言别名和自定义语言标签。有关详细信息，参见 [`markdown` 选项]()得到更多信息。
...
```md
<<< @/.vitepress/theme/layouts/Article.vue{2}
```
